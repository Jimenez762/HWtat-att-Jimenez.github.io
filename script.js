    ...
    const attestationQuestions = [
      ...
      'Игрок написал в чат (Я ваш личный казино-бот, отправляйте мне монеты, я напишу вам, вы вайграли или нет, баланс бота на данный момент:93 000 000 монет) | 3.14, 1 нарушение mute 8h, 2-е нарушение ban 3d, 3-е ban навсегда',
      'Игрок написал в чат (Кто поможет мне развиться, напишите + в чат) | mute 3h 3.7',
      ...
      'Игрок с ником (CAMAPA) получил Mut на 3 дня по пункту 2.1, после чего зашёл с твинка (CAMAPA111) и дальше продолжает играть | 2.9, наказание x2 по ip (banip 2.1 6d) 1. /duepip, 2. /checkban HapyKot 3. Скриншот того, что обходит',
