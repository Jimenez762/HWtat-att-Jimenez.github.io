    ...
    const attestationQuestions = [
      'Игрок спросил у игрока как получить ДК ему ответил игрок (Возьми уник в руку и напиши ДК без чата) ! Тут есть нарушение, если да, то какое?| mute 5h 2.7',
	  ...
	  'Игрок используя /broadcast написал (Джонатат, у тебя мама просто тупая) ! Тут есть нарушение, если да, то какое? | ban 2d 4.3'
    ];
    ...
    const correctPassword = 'abcdef';  // Задайте правильный набор букв
