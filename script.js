    ...
    const teacherQuestions = [
      ...
      'Игрок с изменённым ник-неймом (Makson1gg) в бане за нарушение 2.8 после зашел с аккаунта (Makson111) и дальше продолжает общаться ! Тут есть нарушение, если да, то какое? | 2.9, наказание x2 по ip 1. /duepip, 2. /checkban 3. Скриншот того, что пишет в чат',
