    ...
    const attestationQuestions = [
      'Донатер написал в Глобалный чат пропишите команду /clear и получишь ДонатКейс  ! Тут есть нарушение, если да, то какое?| mute 5h 2.7',
      'Игрок на лайт анархии написал игроку Jimenez (Привет, игрок Baba200, проживает в Китае, улица Козлова, дом 9) ! Тут есть нарушение, если да, то какое?| /banip 2.15 (В лобби сервера)',
      'Во время сделки вы попросили чек покупки, но (покупатель отказался его скидывать) ! Тут есть нарушение, если да, то какое?| ban 10d 1.8',
      ...
      'Игрок написал в личные сообщение Модератору HolyWorld (Брат, твоя Мама слегка тупая) ! Тут есть нарушение, если да, то какое? | mute 7h 3.6',
      'Игрок написал в чат (Я ваш личный казино-бот, отправляйте мне монеты, я напишу вам, вы вайграли или нет, баланс бота на данный момент:1 000 000 монет) ! Тут есть нарушение, если да, то какое? | 3.14, 1 нарушение mute 8h, 2-е нарушение ban 3d, 3-е ban навсегда',
      'Игрок написал в чат (Кто угадает сколько лет моему другу каждый получит по 1000 монет) ! Тут есть нарушение, если да, то какое? | mute 3h 3.7',
      'Игрок написал в чат (Пошли на Рилик ЖИВО!) ! Тут есть нарушение, если да, то какое?  | ban 14d 3.1 (Призыв пойти)',
      'Игрок на лайте написал в чат (Продам дюп на камень, писать в вк) ! Тут есть нарушение, если да, то какое? | ban 3d 2.13',
      'Игрок выдал МУТ игроку с причиной (Много Осков) и отправил доказательства в архив через 10 минут ! Тут есть нарушение, если да, то какое? | ban 7d 4.1',
      'Игрок замутил игрока (Арта_не_умба) по причине (тестируем муты) ! Тут есть нарушение, если да, то какое? | ban 7d 4.2?',
      'Игрок (ХелиКоптер) забанил своего твинка по причине 1.2 ! Тут есть нарушение, если да, то какое? | ban 14d 2.1',
      'Тебе обращается игрок с просьбой рассказать про проект HolyWorld, имея ник-нейм (Админы_Пиздец_тупые) ! Тут есть нарушение, если да, то какое? | /warn 2h, /ban 1.5',
      ...
      'Игрок (JakeTop4ek) получил бан за нарушение правил 3.14, после чего зашёл с другого аккаунта (JakeTop11) и дальше продолжает играть ! Тут есть нарушение, если да, то какое? | 2.9, наказание x2 по ip 1. /duepip, 2. /checkmut  3. Скриншот того, что обходит',    
    ...
    const correctPassword = 'Colin100';  // Задайте правильный набор букв
