    ...
    const teacherQuestions = [
      ...
      'Игрок пишет в чат (Напиши, что ты модератор и тебе реально стажерку выдадут) | ban 7d 2.6',
    ...
    const attestationQuestions = [
      ...
      'Во время сделки игроки пытаются сорвать ее разными способами | ban 10d 1.8',
      ...
      'Ты увидел в чате игрока с ником (Lox_Bupsek) | выдать /warn 2h, потом /ban 1.5',
      'Игрок написал в чат (Кто купит дк или рубины за ресы + монеты, писать в дс) | 6.1 При первом нарушении ban 5d, 2-е навсегда',
      'Игрок с ником (HapyKot) получил ban на 30 дней по пункту 2.5, после чего зашёл с твинка (HapyKot11) и дальше продолжает играть | 2.9, наказание x2 по ip (banip 2.9 60d) 1. /duepip, 2. /checkban _Darkdeath_ 3. Скриншот того, что обходит',
      'Игрок написал в чат, Вот бы кого-нибудь забанить | нету нарушений',
