    ...
    const attestationQuestions = [
      'Игрок "Бублик28" сообщил в локальный чат хотите Уникальный.Донат.Кейс? (пропиши команду /suicide 2 раза и получите свой приз) ! Тут есть нарушение, если да, то какое? |  mute 5h 2.7',
      'Игрок на лайт-анархии написал игроку в личное сообщение: (Хочешь, я солью твой номер телефона?) ! Тут есть нарушение, если да, то какое? | /muteip 2.15',
      'Игрок купил кейс с титулом, но игроку не пришла покупка запросил (чек покупки) но покупатель отказался скидывать ! Тут есть нарушение, если да, то какое? |  ban 10d 1.8',
      'Игрок нписал в чат, Напишите в /cr (Мама_твоя_тотем_вонючая) и получите 1000рубинов/сапфиров ! Тут есть нарушение, если да, то какое? | ban 7d 2.6',
      'Игрок написал в чат (Папа твой дурак) ! Тут есть нарушение, если да, то какое? | mute 7h 3.6',
      'Игрок написал в чат (ALL открылось казино у бобрека /tpa bobrkqwx (поймай 3X) ! Тут есть нарушение, если да, то какое? | ( 3.14, 1-e mute 8h; 2-е ban 3d; 3-е ban навсегда  )',
      'Игрок написал в чат (Кто тим за 1000.рублей? в чат +) ! Тут есть нарушение, если да, то какое? | mute 3h 3.7',
      ...
      'Игрок на Классике (Закрылся в трапке в стене) ! Тут есть нарушение, если да, то какое? | ban 14d 2.13',
      'Игрок выдал блокировку чата(мут) игроку (Ася) с причиной (Оскорбил родню) и отправил доказательства в архив через 10 минут ! Тут есть нарушение, если да, то какое? | ban 7d 4.1',
      'Игрок (Джиминус) замутил игрока (Ульяна) в причине вписал слово (Захотел) ! Тут есть нарушение, если да, то какое? | 7d 4.2?',
      'Игрок (ЕгорХак) забанил свой твинк Аккаунт с причиной 1.2 ! Тут есть нарушение, если да, то какое? | ban 14d 2.1',
      'Тебе обратился игрок с просьбой провести сделку имея ник-нейм (Модер_неуместный_лох)  ! Тут есть нарушение, если да, то какое? | /warn 2h, /ban 1.5',
