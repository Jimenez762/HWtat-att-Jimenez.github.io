    ...
    const attestationQuestions = [
      ...
      'Игрок замутил своего твинка по причине (Lox) | ban 7d 4.2?',
      ...
      'Игрок с ником (HapyKot) получил ban на 30 дней по пункту 2.5, после чего зашёл с твинка (HapyKot11) и дальше продолжает играть | 2.9, наказание x2 по ip (banip 2.9 60d) 1. /duepip, 2. /checkban HapyKot 3. Скриншот того, что обходит',
